...
TEST_CASE("Boids.cpp functions")
{
    ...
    SUBCASE("periodize and BoidsAreNear")
    {
        bds::boid i{};
        bds::boid j{};
        double dist{5.};
    ...
    SUBCASE("Velocity modifier functions")
    {
    ...
    SUBCASE("Testing velocity modifier")
    {
        std::vector<bds::boid> test_vector;
        couple pi{0., 0};
        couple vi{0., 0.}; //se sono fermi non ce ne frega un cazzo
...
TEST_CASE("statistics.cpp functions")
{
    ...
    std::vector<couple> pos_vector = {{1., 2.5}, {3., 1.2}, {6., 4.}, {5., 3.5}, {4., 2.3}, {1.6, 7.}, {4.1, 6.1} , {2.4, 5.4}};
    std::vector<couple> vel_vector = {{4., 5.1}, {4., 6.}, {1.2, 5.3}, {4.1, 1.}, {3.2, 7.}, {4.6, 8.}, {1.5, 2.8}, {6.4, 4.1}};
